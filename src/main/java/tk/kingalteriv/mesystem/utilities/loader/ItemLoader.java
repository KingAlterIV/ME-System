...
public class ItemLoader {
    ...
    public static void loadAllItems() {
        MESystem.ITEM_ME_TERMINAL = ItemBuilder.of(Material.SNOWBALL)
                ...
                .applyPersistentData(container -> {
                    container.set(MNamespacedKeys.ME_SYSTEM_ITEM_TYPE, MEPersistentDataTypes.ME_ITEM_TYPE_ENUM, MEItemType.METerminal);
        ...
        MESystem.ITEM_ME_DRIVE = ItemBuilder.of(Material.SNOWBALL)
                ...
                .modelData(70)
                .applyPersistentData(container -> {
                    container.set(MNamespacedKeys.ME_SYSTEM_ITEM_TYPE, MEPersistentDataTypes.ME_ITEM_TYPE_ENUM, MEItemType.MEDrive);
                }).build();
        ...
        MESystem.ITEM_ME_CELL_1 = ItemBuilder.of(Material.SNOWBALL)
                ...
                .modelData(71)
                .applyPersistentData(container -> {
                    container.set(MNamespacedKeys.ME_SYSTEM_ITEM_TYPE, MEPersistentDataTypes.ME_ITEM_TYPE_ENUM, MEItemType.MECell);
